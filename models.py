...
class Product(BaseModel):
    ...
    category = peewee.ForeignKeyField(Category, related_name='category_products')
    file_join = peewee.ForeignKeyField(FileJoin, null=True, related_name='file_joins_products')
...
class Invoice(BaseModel):
    ...
    subject = peewee.CharField(max_length=100, null=True, verbose_name=("Objet"))

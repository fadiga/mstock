...
# reportlab explicit import to satisfy py2exe
# hope we can get rid of that someday
# try:
...
#     from elements import PageBreak, Section, Table, \
#                      Text, Paragraph, Document, HLine
# except:
#     pass
